"""Extended metadata for yaml_get_command command."""
from __future__ import annotations

from typing import Any, Type


def get_yaml_get_command_metadata(cls: Type[Any]) -> dict[str, Any]:
    """Return AI/documentation metadata for yaml_get_command."""
    return {
        "name": cls.name,
        "version": cls.version,
        ...
        "detailed_description": (
            "YAML convenience command yaml_get_command."
        ),
        "parameters": {
"session_key": {"type": "string", "description": "UUID4 session identifier."}
        ...
        "usage_examples": [
            {
                "description": "Typical yaml_get_command invocation",
                "command": {},
