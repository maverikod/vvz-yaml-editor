...
def get_file_close_metadata(cls: Type[Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "author": cls.author,
        "email": cls.email,
        "detailed_description": "File command file_close via api.close_buffer.",
        "parameters": {
            "session_key": {
                "type": "string",
            ...
            "buffer_id": {
                "type": "string",
                "description": "Open buffer identifier.",
                "required": True,
            },
            "force": {
                "description": "Force close even with unsaved changes.",
                "type": "boolean",
                "required": False,
                "default": False,
            },
        ...
        "usage_examples": [
            {
                "description": "Typical file_close invocation",
